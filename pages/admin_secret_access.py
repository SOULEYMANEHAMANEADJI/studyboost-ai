...
def main():
    ...
    with tab4:
        ...
        with c2: chat_q = st.number_input("Messages/jour", 0, 100, int(settings.get("quota_chat_per_day", "15")), key="q_chat")
        with c3: search_q = st.number_input("Recherches/jour", 0, 100, int(settings.get("quota_search_per_day", "15")), key="q_search")
